...
<!-- Bootstrap Core CSS -->
<link href='<c:url value="/resources/pooled/css/bootstrap.min.css"/>' rel="stylesheet" > 
<!-- Custom CSS -->
<link href='<c:url value="/resources/pooled/css/style.css"/>' rel="stylesheet" type='text/css'>
<link href='<c:url value="/resources/pooled/css/morris.css"/>' rel="stylesheet" type='text/css'> 
<!-- Graph CSS -->
<link href='<c:url value="/resources/pooled/css/font-awesome.css"/>' rel="stylesheet" > 
<!-- jQuery -->
<script src='<c:url  value="/resources/pooled/js/jquery-2.1.4.min.js"/>'> </script> 
<!-- //jQuery -->
<link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'/>
<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<!-- lined-icons -->
<link href='<c:url value="/resources/pooled/css/icon-font.min.css"/>' rel="stylesheet" type='text/css' > 
<!-- //lined-icons -->
</head> 
<body>
								...
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											   <div class="user_img"><img alt="" src="<c:url value = "/resources/pooled/images/in11.jpg"/>">  </div>
											...
											<li class="odd"><a href="#">
												<div class="user_img"><img alt="" src="<c:url value = "/resources/pooled/images/in10.jpg"/>"> </div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor </p>
												<p><span>1 hour ago</span></p>
												</div>
											...
											<li><a href="#">
											   <div class="user_img"><img alt="" src="<c:url value = "/resources/pooled/images/in9.jpg"/>"> </div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
												<div class="user_img"><img alt="" src="<c:url value = "/resources/pooled/images/in8.jpg"/>"> </div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li class="odd"><a href="#">
												<div class="user_img"><img alt="" src="<c:url value = "/resources/pooled/images/in6.jpg"/>"> </div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li><a href="#">
												<div class="user_img"><img alt="" src="<c:url value = "/resources/pooled/images/in7.jpg"/>"> </div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img alt="" src="<c:url value = "/resources/pooled/images/in4.jpg"/>">  </span> 
												<div class="user-name">
													<p>Malorum</p>
                                ...
                                <div class="card-body p-b-20">
                                    <div class="list-group">
                                        <a class="list-group-item media" href="">
                                             <div class="pull-left">
                                             	<img class="lg-item-img" alt="" src="<c:url value = "/resources/pooled/images/in1.jpg"/> ">  
                                            </div>
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" alt="" src="<c:url value = "/resources/pooled/images/in2.jpg"/> ">  
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" alt="" src="<c:url value = "/resources/pooled/images/in3.jpg"/> ">  
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" alt="" src="<c:url value = "/resources/pooled/images/in4.jpg"/> "> 
                                            </div>
                                            <div class="media-body">
                                            	<div class="pull-left">
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="/FrameWorkOriented/dashboard"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
										 
										 <li id="menu-academico" ><a href="/FrameWorkOriented/product-management"><i class="fa fa-cubes nav_icon"></i><span>Product</span><div class="clearfix"></div></a></li>
...
<!--js -->
<script src='<c:url  value="/resources/pooled/js/jquery.nicescroll.js"/>'> </script>
<script src='<c:url  value="/resources/pooled/js/scripts.js"/>'> </script> 
<!-- Bootstrap Core JavaScript -->
<script src='<c:url  value="/resources/pooled/js/bootstrap.min.js"/>'> </script> 
   <!-- /Bootstrap Core JavaScript -->	   
<!-- morris JavaScript -->	
<script src='<c:url  value="/resources/pooled/js/raphael-min.js"/>'> </script>
<script src='<c:url  value="/resources/pooled/js/morris.js"/>'> </script> 
